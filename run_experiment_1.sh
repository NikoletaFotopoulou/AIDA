...
sudo ovs-ofctl add-flow s8 in_port=4,actions=output:3
sudo ovs-ofctl add-flow s7 in_port=3,actions=output:1

sudo ovs-ofctl add-flow s7 in_port=1,actions=output:3
sudo ovs-ofctl add-flow s8 in_port=3,actions=output:4
